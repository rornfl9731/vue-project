    ...
    <b-row>
      ...
      <b-col cols="8">
        <b-container class="bv-example-row" style="margin-top:10px;">
           <b-card> <h2 style="background-color:">즉시 납부</h2></b-card>
          <b-jumbotron>
...
<b-card-text style="textAlign:left"><span style="font-size:30px">모바일</span> &nbsp;&nbsp;&nbsp;&nbsp;<span style="padding-left:10em;font-size:20px"><b>{{phone}}</b></span></b-card-text>
              ...
              <br>
              <b-card>
              <b-card-text style="textAlign:center;height:60px;"><span style="font-size:30px">납부하실 금액은</span> &nbsp;&nbsp;<span style="font-size:30px;color:red"><b>{{numberWithCommas(mo)}}</b></span><span style="font-size:30px">원 입니다.</span></b-card-text>
              </b-card>
              <hr>
              <b-card-text style="textAlign:left"><span style="font-size:30px;color:red">01</span> &nbsp;&nbsp;<span style="font-size:20px">납부 가능한 요금 확인 후, 납부하실 금액을 선택해주세요.</span></b-card-text>
  ...
  <br>
  <b-button href="#" variant="danger">바로 납부</b-button>
               </b-container>
